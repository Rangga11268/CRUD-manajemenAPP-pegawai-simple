<x-guest-layout>
    <div class="mb-10 text-center lg:text-left">
        ...
        <p class="mt-2 text-base text-gray-500">Join us and start managing your team efficiently.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                class="block w-full pl-11 pr-4 py-4 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white text-base shadow-sm">
            </div>
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                class="block w-full pl-11 pr-12 py-4 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white text-base shadow-sm">
        ...
        <div class="pt-4">
            <button type="submit" class="w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-base font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 ease-in-out transform hover:-translate-y-0.5 tracking-wide">
                Register Account
            </button>
        </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-sm text-gray-500">
                ...
                <a href="{{ route('login') }}" class="font-bold text-blue-600 hover:text-blue-700 transition duration-150 ease-in-out ml-1">
                    Log in here
                </a>
            </p>
        </div>
