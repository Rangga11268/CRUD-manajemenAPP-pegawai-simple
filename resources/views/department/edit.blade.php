...
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <h2 class="mb-0">Edit Department: {{ $department->name }}</h2>
        ...
        <form action="{{ route('department.update', $department) }}" method="POST">
            ...
            <div class="form-group">
                <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $department->is_active) == '1' ? 'checked' : '' }}>
