...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Manajemen SDM</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('home') }}" class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-500">
                            Manajemen SDM
                        </a>
                    </div>
        ...
        <footer class="bg-gray-900 border-t border-gray-800">
            <div class="max-w-7xl mx-auto px-6 py-12 lg:px-8">
                ...
                <div class="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
                    &copy; {{ date('Y') }} Manajemen SDM App. All rights reserved.
                </div>
            </div>
        </footer>
    </div>
