    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="{{ route('dashboard') }}" class="flex ms-2 md:me-24">
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SIMPEG</span>
        </a>
      </div>
      <div class="flex items-center">
          <div class="flex items-center ms-3 space-x-4">
            ...
            <!-- Notification Bell -->
            <button type="button" class="relative inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400" onclick="window.location.href='{{ route('notifications.index') }}'">
                <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C8.13 2 5 5.13 5 9V15L3 17V18H21V17L19 15V9C19 5.13 15.87 2 12 2ZM17 19H7V20C7 21.1 7.9 22 9 22H15C16.1 22 17 21.1 17 20V19Z"/>
                </svg>
            ...
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                ...
                <div class="w-8 h-8 rounded-full flex items-center justify-center bg-gray-300 text-gray-700 font-bold uppercase">
